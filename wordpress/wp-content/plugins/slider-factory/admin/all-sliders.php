<div class="sf-panel p-3 m-3" style="">
	<div class="row mb-3 bg-dark bg-gradient" style="--bs-gutter-x: 0rem;">
		<div class="col-6">
			<div class="p-3">
				<h1 class="sf-heading"><?php _e('SLIDER LAYOUTS', 'slider-factory'); ?></h1>
			</div>
		</div>
		<div class="col-6">
			<div class="p-3">
				<button class="btn btn-lg btn-danger bg-gradient float-end" data-bs-toggle="modal" data-bs-target="#sf-sliders"><strong><?php _e('All Slider Shortcode', 'slider-factory'); ?></strong></button>
			</div>
		</div>
	</div>
	...
	<div class="row" style="--bs-gutter-x: 0rem;">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 1</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-1.jpg">
				<div class="p-3">
					...
					<i class="fas fa-info"></i> <?php _e('Info', 'slider-factory'); ?>
					</button>
					<a href="https://wpfrank.com/demo/slider-factory-free-wordpress-plugin/layout-1/" target="_blank" id="slider-demo" class="slider-demo btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;">
						<i class="fas fa-desktop"></i> <?php _e('Demo', 'slider-factory'); ?>
					</a>
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=1">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 2</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-2.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=2">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 3</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-3.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=3">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 4</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-4.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=4">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 5</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-5.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=5">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 6</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-6.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=6">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 7</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-7.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=7">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 8</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-8.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=8">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-bottom box">
				<div class="ribbon"><span><?php _e('LAYOUT', 'slider-factory'); ?> 9</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-9.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=9">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-bottom box">
				<div class="ribbon"><span>LAYOUT 10</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-10.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=10">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-bottom box">
				<div class="ribbon"><span>LAYOUT 11</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-11.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=11">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-bottom box">
				<div class="ribbon"><span>LAYOUT 12</span></div>
				<img class="img-fluid" src="<?php echo plugin_dir_url(__FILE__); ?>assets/banners/layout-12.jpg">
				<div class="p-3">
					...
					<a class="btn btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;" href="admin.php?page=sf-manage-slider&sf-slider-action=create&sf-slider-layout=12">
						<i class="fas fa-plus"></i> <?php _e('Create', 'slider-factory'); ?>
					</a>
				</div>
			</div>
	...
	<div class="row my-3">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('GET PRO', 'slider-factory'); ?></span></div>
				<div class="p-3">
					<img class="img-fluid" style="height: 391px;" src="<?php echo plugin_dir_url(__FILE__); ?>assets/images/slider-factory-pro-banner.png">	
				</div>
			</div>
		</div>
		...
		<div class="col-lg-6 col-md-6 col-sm-6">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('FEATURES', 'slider-factory'); ?></span></div>
				<div class="p-3">
					<h3 class="py-3 text-secondary"><?php _e('Upgrade To Pro Version', 'slider-factory'); ?></h3>
					<ul class="list-group">
						<li class="list-group-item">Multiple Slider Layouts & Presets</li>
				...
				<div class="p-3">
					<a href="https://wpfrank.com/wordpress-plugins/slider-factory-pro/" target="_blank" class="slider-info btn btn-lg btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;">
						<i class="fas fa-info"></i> <?php _e('Slider Factory Pro', 'slider-factory'); ?>
					</a>
					<a href="https://wpfrank.com/demo/slider-factory-pro/" target="_blank" id="slider-demo" class="slider-demo btn btn-lg btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;">
						<i class="fas fa-desktop"></i> <?php _e('Check Pro Demo', 'slider-factory'); ?>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			<div class="sf-inner-box shadow-sm m-2 text-center border-end border-top border-bottom box">
				<div class="ribbon"><span><?php _e('Video Docs', 'slider-factory'); ?></span></div>
				<div class="p-3">
					<div>
						<h2 class="m-3"><?php _e('Watch Video Documentation', 'slider-factory'); ?></h2>
					...
					<div class="p-3">
						<a href="https://wpfrank.com/slider-factory-free-wordpress-plugin-documentation/" target="_blank" class="btn btn-lg btn-danger bg-gradient" style="background-color: #e76f51; border-color: #e76f51;">
							<?php _e('Read Text Documentation', 'slider-factory'); ?>
						</a>
					</div>
				</div>
			</div>
...
$all_sliders = $wpdb->get_results(
	$wpdb->prepare("SELECT option_name FROM `$options_table_name` WHERE `option_name` LIKE %s ORDER BY option_id ASC", '%'.$slider_key.'%')
);
?>
	...
	<div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="sf-sliders-label"><?php _e('Slider Shortcodes', 'slider-factory'); ?></h5>
			...
			<div class="modal-body">
				<table class="table">
					<thead class="table-dark">
						<tr>
							<!--<th scope="col">#</th>-->
							<th scope="col"><?php _e('Title', 'slider-factory'); ?></th>
							<th scope="col"><?php _e('Shortcode', 'slider-factory'); ?></th>
							<th scope="col"><?php _e('Action', 'slider-factory'); ?></th>
					...
					<tbody id="sf-tbody">
						...
						if($wpdb->num_rows) {
							...
							foreach($all_sliders as $slider){
								...
								//print_r($slider);
								if(isset($slider['sf_slider_id'])) $sf_slider_id = $slider['sf_slider_id']; else $sf_slider_id = "";
								if(isset($slider['sf_slider_title'])) $sf_slider_title = $slider['sf_slider_title']; else $sf_slider_title = "";
								if(isset($slider['sf_slider_layout'])) $sf_slider_layout = $slider['sf_slider_layout']; else $sf_slider_layout = "";
								$sf_slider_shortcode = '[sf id='.$sf_slider_id.' layout='.$sf_slider_layout.']';
								if($sf_slider_id && $sf_slider_layout) {
						?>
						<tr id="<?php echo $sf_slider_id; ?>">
							<!--<th scope="row"><?php echo $sf_counter; ?>.</th>-->
							<td><?php echo $sf_slider_title; ?></td>
							<td>
								<input type="text" id="sf-slider-shortcode-<?php echo $sf_slider_id; ?>" class="btn btn-info btn-sm" value="<?php echo $sf_slider_shortcode; ?>">
								<button type="button" id="sf-copy-shortcode-<?php echo $sf_slider_id; ?>" class="btn btn-info btn-sm" title="<?php _e('Click To Copy Slider Shortcode', 'slider-factory'); ?>" onclick="return WpfrankSFCopyShortcode('<?php echo $sf_slider_id; ?>');"><?php _e('Copy', 'slider-factory'); ?></button>
								<button class="btn btn-sm btn-success d-none sf-copied-<?php echo $sf_slider_id; ?>"><?php _e('Copied', 'slider-factory'); ?></button>
							</td>
							<td>
								<button type="button" id="sf-clone-slider" class="btn btn-warning btn-sm" title="<?php _e('Clone Slider', 'slider-factory'); ?>" value="<?php $sf_slider_id; ?>" onclick="return WpfrankSFCloneSlider('<?php echo $sf_slider_id; ?>', '<?php echo $sf_counter; ?>');"><i class="fas fa-copy"></i></button>
								<a href="admin.php?page=sf-manage-slider&sf-slider-action=edit&sf-slider-id=<?php echo $sf_slider_id; ?>&sf-slider-layout=<?php echo $sf_slider_layout; ?>" id="sf-edit-slider" class="btn btn-warning btn-sm" title="<?php _e('Edit Slider', 'slider-factory'); ?>"><i class="fas fa-edit"></i></a>
								<button id="sf-delete-slider" class="btn btn-warning btn-sm" title="<?php _e('Delete Slider', 'slider-factory'); ?>" value="<?php echo $sf_slider_id; ?>" onclick="return WpfrankSFremoveSlider('<?php echo $sf_slider_id; ?>', 'single');"><i class="fas fa-trash-alt"></i></button>
							</td>
							<td class="text-center">
								<input type="checkbox" id="sf-slider-id" name="sf-slider-id" value="<?php echo $sf_slider_id; ?>" title="<?php _e('Select Slider Shortcode', 'slider-factory'); ?>">
							</td>
						</tr>
						<?php
									$sf_counter++;
					...
					<thead class="table-dark">
						<tr>
							...
							<th scope="col"><?php _e('Shortcode', 'slider-factory'); ?></th>
							<th scope="col"><?php _e('Action', 'slider-factory'); ?></th>
							<th scope="col" class="text-center"><button type="button" id="sf-delete-selected" class="btn btn-danger btn-sm" title="<?php _e('Delete Selected Sliders', 'slider-factory'); ?>" onclick="return WpfrankSFremoveSlider('', 'multiple');"><i class="fas fa-trash-alt"></i></button></th>
						</tr>
					</thead>
				</table>
			</div>
...
function WpfrankSFCloneSlider(sf_slider_id, sf_slider_counter){
	...
	jQuery.ajax({
		...
		data: {
			...
			'nonce': "<?php echo wp_create_nonce( 'sf-clone-slider' ); ?>",
			//slider info
...
function WpfrankSFremoveSlider(sf_slider_id, do_action){
	...
	jQuery.ajax({
		...
		data: {
			...
			'nonce': "<?php echo wp_create_nonce( 'sf-remove-slider' ); ?>",
			//slider info
			'sf_slider_id': sf_slider_id,
		}, 
		success: function (result) {
