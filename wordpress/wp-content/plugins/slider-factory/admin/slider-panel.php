<div class="p-3 m-3 sf-panel">
	<input type="hidden" class="form-control item-menu" name="sf_slider_id" id="sf_slider_id" value="<?php echo $sf_slider_id; ?>">
	<input type="hidden" class="form-control item-menu" name="sf_slider_layout" id="sf_slider_layout" value="<?php echo $sf_slider_layout; ?>">
	<!-- slider header start -->
	<div class="row px-3">
		<div class="col-md-12">
			<h2 class="py-2 sf-title"><?php echo $sf_slider_heading; ?></h2>
		</div>
	</div>
	<!-- slider header end -->
	...
	<div class="row mt-2 p-3">
		<div class="col-md-12">
			<h3 class="sf-panel-heading bg-dark bg-gradient p-3"><?php _e('Slider Title', 'slider-factory'); ?></h3>
		</div>
		<div class="col-md-12">
			<div class="p-3 sf-panel-setting">
				<input type="text" class="form-control item-menu w-50" name="sf_slider_title" id="sf_slider_title" placeholder="<?php _e('Type A Name Of The Slider', 'slider-factory'); ?>" value="<?php echo $sf_slider_title; ?>">
				<div id="sf-1-width-help" class="form-text sf-tooltip"><?php _e('Give a name or title to the slider.', 'slider-factory'); ?></div>
			</div>
		</div>
	</div>
	<!-- slider title end -->
	...
	<div class="row mt-2 p-3">
		<div class="col-md-12">
			<h3 class="sf-panel-heading bg-dark bg-gradient p-3"><?php _e('Upload Image Slides', 'slider-factory'); ?></h3>
		</div>
		
		<div class="col-md-6 text-center py-2">
			<div class="p-3 sf-panel-setting">
			<div class="d-grid gap-2 x-auto">
				<button type="button" id="sf-upload-slides" class="btn btn-success bg-gradient btn-lg p-3 fs-1" style="background-color: #80b918; border-color: #80b918;"><i class="fas fa-plus"></i> <?php _e('Add New Image Slides', 'slider-factory'); ?></button>
			</div>
			</div>
		</div>
		<div class="col-md-6 text-center py-2">
			...
			<div class="d-grid gap-2 mx-auto">
				<button type="button" class="btn btn-danger bg-gradient btn-lg p-3 fs-1" onclick="return WpfrankSFremoveAllSlides();" style="background-color: #e76f51; border-color: #e76f51;"><i class="fas fa-trash"></i> <?php _e('Remove All Image Slides', 'slider-factory'); ?></button>
			</div>
			</div>
		</div>
	</div>
	...
	<div id="sf-slides-help" class="form-text sf-tooltip px-3">
		<strong><?php _e('Drag and Drop image slides to rearrange their position.', 'slider-factory'); ?></strong><br><strong><?php _e('Note', 'slider-factory'); ?>: </strong><?php _e('We recommend to use the same dimension images for better result.', 'slider-factory'); ?>
	</div>
	...
	jQuery(document).ready(function () {
		...
		jQuery( function() {
			...
			//jQuery( "#sf-slides" ).disableSelection();
		});
	});
	</script>
	<div id="sf-slides" class="row sf-slides p-3 m-3 sf-panel-setting">
		...
		if(isset($slider['sf_slide_id'])) {
			foreach($slider['sf_slide_id'] as $id) {
				...
				?>
				<div class="sf-slide-column col-md-4 col-lg-4 col-xl-2 my-2 sf_slide_<?php echo $attachment_id; ?>" data-position="<?php echo $attachment_id; ?>">
	...
	<div class="row mt-5 p-3">
		<div class="col-md-12">
			<h3 class="sf-panel-heading bg-dark bg-gradient p-3"><?php _e('Slider Setting For Layout', 'slider-factory'); ?> <?php echo $sf_slider_layout; ?></h3>
			<?php
		...
		<div class="col-md-12 py-3">
			<div class="p-3 sf-panel-setting">
				<div id="sf-slider-process" class="spinner-grow m-3 text-dark d-none" role="status">
					<span class="visually-hidden"><?php _e('Loading...', 'slider-factory'); ?></span>
				</div>
				<button type="button" id="sf-save-slider" class="btn btn-success bg-gradient btn-lg fs-2 m-3" style="background-color: #e76f51; border-color: #e76f51;"><strong><i class="fas fa-save"></i> <?php echo $sf_slider_button_text; ?></strong></button>
				
				<!-- slider shortcode start -->
				<div id="sf-shortcode-content" class="py-3 m-3 <?php if($sf_slider_action == 'create') echo "d-none"; ?>">
					<?php $shortcode = '[sf id='.$sf_slider_id.' layout='.$sf_slider_layout.']'; ?>
					<input type="text" class="btn btn-lg fs-2" id="sf-slider-shortcode-text" value="<?php echo $shortcode; ?>">
					<button type="button" id="sf-copy-slider-shortcode-btn" class="btn btn-success bg-gradient btn-lg fs-2" onclick="return WpfrankSFCopyShortcode();" style="background-color: #e76f51; border-color: #e76f51;"><i class="fas fa-copy"></i> <?php _e('Click To Copy Shortcode', 'slider-factory'); ?></button>
					<button id="sf-copied" class="btn btn-lg btn-light d-none"><?php _e('Shortcode Copied', 'slider-factory'); ?></button>
				</div>
	...
	<div class="row p-3">
		<div class="col-md-12 text-center py-2">
				...
				<a href="https://wpfrank.com/account/signup/slider-factory-pro" target="_blank" id="slider-demo" class="btn btn-success bg-gradient btn-lg p-3 fs-1 col-md-6" style="background-color: #56b8c5; border-color: #56b8c5;">
					<i class="fas fa-shopping-cart"></i> <?php _e('Upgrade to Pro', 'slider-factory'); ?>
				</a>
	...
	<!-- backup code for buy pro bttn -->
	<!--	<div class="d-grid gap-2 x-auto">
		<a href="https://wpfrank.com/account/signup/slider-factory-pro" target="_blank" id="slider-demo" class="btn btn-success bg-gradient btn-lg p-3 fs-1" style="background-color: #56b8c5; border-color: #56b8c5;">
			<i class="fas fa-shopping-cart"></i> <?php _e('Upgrade to Pro', 'slider-factory'); ?>
		</a>
	</div>
