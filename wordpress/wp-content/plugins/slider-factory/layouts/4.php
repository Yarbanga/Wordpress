...
//slider settings
if(isset($slider['sf_4_width'])) $sf_4_width = $slider['sf_4_width']; else $sf_4_width = "100%";
if(isset($slider['sf_4_height'])) $sf_4_height = $slider['sf_4_height']; else $sf_4_height = "100%";
if(isset($slider['sf_4_auto_play'])) $sf_4_auto_play = $slider['sf_4_auto_play']; else $sf_4_auto_play = "true";
if(isset($slider['sf_4_sorting'])) $sf_4_sorting = $slider['sf_4_sorting']; else $sf_4_sorting = 0;
...
jQuery( document ).ready(function() {
	...
	jQuery('.sf-4-<?php echo $sf_slider_id; ?>').camera({
		autoAdvance:<?php echo $sf_4_auto_play; ?>,
	});
});
</script>

<!-- slider start-->
 <div class="sf-4-<?php echo $sf_slider_id; ?>">
	<?php
		// slide sorting start
		if($sf_4_sorting == 1){
		...
		if(isset($slider['sf_slide_title'])) {
			foreach($slider['sf_slide_title'] as $id => $value) {
				...
				?>
				<div data-src="<?php echo $sf_slide_full_url[0]; ?>">
					<img class="sf-4-slide-image" src="<?php echo $sf_slide_full_url[0]; ?>" alt="<?php echo $sf_slide_alt; ?>">
					
					<?php if($sf_slide_title != "" || $sf_slide_descs != "") { ?>
					<div class="camera_caption sf-4-slide-content">
						<?php if($sf_slide_title != "") { ?>
						<p class="sf-4-slide-title"><?php echo $sf_slide_title; ?></p>
						<?php } ?>
						<?php if($sf_slide_descs != "") { ?>
						<p class="sf-4-slide-desc"><?php echo $sf_slide_descs; ?></p>
						<?php } ?>
					</div>
					<?php } ?>
				</div>
...
<style>
.sf-4-<?php echo $sf_slider_id; ?> {
	width: <?php echo $sf_4_width; ?>;
	height: <?php echo $sf_4_height; ?>;
}
