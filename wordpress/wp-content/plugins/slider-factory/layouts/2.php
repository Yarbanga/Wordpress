...
//slider settings
if(isset($slider['sf_2_width'])) $sf_2_width = $slider['sf_2_width']; else $sf_2_width = "100%";
if(isset($slider['sf_2_height'])) $sf_2_height = $slider['sf_2_height']; else $sf_2_height = "100%";
if(isset($slider['sf_2_sorting'])) $sf_2_sorting = $slider['sf_2_sorting']; else $sf_2_sorting = 0;
...
jQuery( document ).ready(function() {
	jQuery(".sf-2-<?php echo $sf_slider_id; ?>").photoroller({	});
});
</script>

<!-- slider start-->
<div class="sf-2-<?php echo $sf_slider_id; ?>">
	<?php
	// slide sorting start
	if($sf_2_sorting == 1){
	...
	if(isset($slider['sf_slide_title'])) {
		foreach($slider['sf_slide_title'] as $id => $value) {
			...
			<div class="sf-2-slide">
				<img class="sf-2-slide-image" src="<?php echo $sf_slide_full_url[0]; ?>" alt="<?php echo $sf_slide_alt; ?>">
...
<style>
.sf-2-<?php echo $sf_slider_id; ?> {
	width: <?php echo $sf_2_width; ?>;
	height: <?php echo $sf_2_height; ?>;
}
