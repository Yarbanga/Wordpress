...
//slider settings
if(isset($slider['sf_11_width'])) $sf_11_width = $slider['sf_11_width']; else $sf_11_width = "100%";
if(isset($slider['sf_11_height'])) $sf_11_height = $slider['sf_11_height']; else $sf_11_height = "750px";
if(isset($slider['sf_11_sorting'])) $sf_11_sorting = $slider['sf_11_sorting']; else $sf_11_sorting = 0;
...
?>
<div class="sf-11-<?php echo $sf_slider_id; ?>">
        ...
        <div class="ps-contentwrapper">
			...
			if(isset($slider['sf_slide_title'])) {
				...
				<div class="ps-content">
						<h2><?php echo $sf_slide_title; ?></h2>
						<p><?php echo $sf_slide_descs; ?></p>					
				</div>
			<?php
			}//end of for each
		} //end of count
            ...
            <div class="ps-slides">
				...
				if(isset($slider['sf_slide_title'])) {
					foreach($slider['sf_slide_title'] as $id => $value) {
						...
						//print_r($sf_slide_full_url);
						?>
				<div style="background-image:url(<?php echo $sf_slide_full_url[0]; ?>);"></div>
						<?php
					}//end of for each
				} //end of count
				?>
...
<style>
.sf-11-<?php echo $sf_slider_id; ?>{
	width:<?php echo $sf_11_width; ?>;
	height:<?php echo $sf_11_height; ?>;
}
</style>
<?php //wp_enqueue_script('sf-11-product-slider-js'); ?>
