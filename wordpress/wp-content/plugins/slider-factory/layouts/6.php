...
//slider settings
if(isset($slider['sf_6_width'])) $sf_6_width = $slider['sf_6_width']; else $sf_6_width = "100%";
if(isset($slider['sf_6_height'])) $sf_6_height = $slider['sf_6_height']; else $sf_6_height = "100%";
if(isset($slider['sf_6_auto_play'])) $sf_6_auto_play = $slider['sf_6_auto_play']; else $sf_6_auto_play = "true";
if(isset($slider['sf_6_sorting'])) $sf_6_sorting = $slider['sf_6_sorting']; else $sf_6_sorting = 0;
...
jQuery(window).on('load', function(){
	jQuery('.sf-6-<?php echo $sf_slider_id; ?>').wipeSlider({
		auto : <?php echo $sf_6_auto_play; ?>,
	});
});
</script>

<div class="slidesWrap sf-6-<?php echo $sf_slider_id; ?>">
	...
	if(isset($slider['sf_slide_title'])) {
		foreach($slider['sf_slide_title'] as $id => $value) {
			...
			?>
			<li class="slide">
				<img src="<?php echo $sf_slide_full_url[0]; ?>" alt="<?php echo $sf_slide_alt; ?>">
...
.slidesWrap .slide{
	width: <?php echo $sf_6_width; ?>;
}
.slidesWrap .slide img{
	width: <?php echo $sf_6_width; ?>;
	height: <?php echo $sf_6_height; ?>;
}
.sf-6-<?php echo $sf_slider_id; ?> {
	width: <?php echo $sf_6_width; ?>;
	height: <?php echo $sf_6_height; ?>;
}
