...
//slider settings
if(isset($slider['sf_12_width'])) $sf_12_width = $slider['sf_12_width']; else $sf_12_width = "100%";
if(isset($slider['sf_12_height'])) $sf_12_height = $slider['sf_12_height']; else $sf_12_height = "auto";
...
<style>
.sf-12-main-<?php echo $sf_slider_id; ?>{
	width: <?php echo $sf_12_width; ?>; /* width */
	height: auto;
}

.sf-12-main-<?php echo $sf_slider_id; ?> img {
	width : 100%;
	<?php if ($sf_12_height == "" || $sf_12_height == "auto") { ?>
	height : auto;
	<?php } else { ?>
	height : <?php echo $sf_12_height; ?>;  /* height in px or auto if blank */
	<?php } ?>
}
	
.sf-12-main-<?php echo $sf_slider_id; ?> .twentytwenty-overlay:hover {
...
<div class="sf-12-main-<?php echo $sf_slider_id; ?>">
	<div class="sf-12-container-<?php echo $sf_slider_id; ?>" class="twentytwenty-container">
		<?php
		// load sides
			if(isset($slider['sf_slide_title'])) {
				foreach($slider['sf_slide_title'] as $id => $value) {
					...
					<img alt="<?php $sf_slide_alt; ?>" src="<?php echo $sf_slide_thumbnail_url[0]; ?>" />
...
jQuery(function(){
	jQuery(".sf-12-container-<?php echo $sf_slider_id; ?>").twentytwenty();
});
</script>