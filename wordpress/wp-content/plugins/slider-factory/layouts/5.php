...
//slider settings
if(isset($slider['sf_5_width'])) $sf_5_width = $slider['sf_5_width']; else $sf_5_width = "500px";
if(isset($slider['sf_5_height'])) $sf_5_height = $slider['sf_5_height']; else $sf_5_height = "400px";
if(isset($slider['sf_5_auto_play'])) $sf_5_auto_play = $slider['sf_5_auto_play']; else $sf_5_auto_play = "false";
if(isset($slider['sf_5_sorting'])) $sf_5_sorting = $slider['sf_5_sorting']; else $sf_5_sorting = 0;
...
?>
<div class="slider-container-<?php echo $sf_slider_id; ?>">
	<ul class="flip-items">
	<?php
	// slide sorting start
	if($sf_5_sorting == 1){
...
jQuery( document ).ready(function() {
	jQuery(".slider-container-<?php echo $sf_slider_id; ?>").flipster({
...
<style>
.slider-container-<?php echo $sf_slider_id; ?> img {
	width : <?php echo $sf_5_width; ?>;
	height : <?php echo $sf_5_height; ?>;
}
