...
To see the class of a widget in "Dashboard - Appearance - Widgets", expand the widget that you've added to the SideMenu widget area and the class name is shown at the bottom.
