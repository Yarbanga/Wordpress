...
[See Widget Demo](https://widgetwhats.com/) | [Register an Account](https://panel.widgetwhats.com/register)
...
Upgrade to premium to get all extra features without limitation.
<blockquote>
* Unlimited Widgets
* Unlimited Agents WhatsApp Number
* Reply Mode - 'Live Chat' look widget style with input type field
* Greeting Message on Each Agents
* Link Recommendation Message with Image on Each Agents
* Suggested Reply to Agents (Coming Soon)
* Widget Visibility Based on Screen Size
* Auto Open Widget Based on Delay Time & Page Scroll
* Facebook Pixel Tracking
* Google Analytics Integration (Coming Soon)
* Widget Color Customization
* Agent Availability Based on Days & Hours (Online & Offline)
* Editable Agent Description & Reply-to Text
</blockquote>

[WidgetWA](https://widgetwhats.com/)
...
WidgetWA offers 24×7 support, click chat widget on [website](https://widgetwhats.com/) and we are glad to help you.

Don't have a WidgetWA account? [Click here to create one for free!](https://panel.widgetwhats.com/)

<small>*WhatsApp and WhatsApp Logo are brand assets and trademark of Facebook, Inc.
WidgetWA is not in partnership, sponsored or endorsed by Facebook, Inc.*</small>

== screenshots ==

1. Widget integration with advance page targeting feature on WordPress Admin
1. WidgetWA in action on website
1. Live chat look style
1. Reply mode with intro chat message
1. Set online/offline each WhatsApp number
1. Beautiful design and fully responsive
1. Facebook pixel integration
1. Widget popup animation
1. Multiple agent in a widget
1. Responsive widget style
...
* Click "WidgetWA" menu from wp-admin
...
* Create an account there, it is free. After that, you will redirect to [Panel WidgetWA](https://panel.widgetwhats.com/)
* Create a widget there and click save.
* There is an embed code after you successfully create widget. Copy number inside DATA-ID tag and paste it into WidgetWA menu on your WP Admin.

= How to unlock all extra features? =

* You need to upgrade from Free Plan to Premium Plan by clicking "Upgrade" menu on [Panel WidgetWA](https://panel.widgetwhats.com/)
...
= 1.0 =
* Hurray! First release of WidgetWA plugin version