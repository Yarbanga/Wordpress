		...
		<div id="ewd-us-dashboard-content-area">
			...
			<div id="ewd-us-dashboard-content-left">
				...
				<div class="ewd-us-dashboard-new-widget-box ewd-widget-box-full" id="ewd-us-dashboard-support-widget-box">
					...
					<div class="ewd-us-dashboard-new-widget-box-bottom">
						<ul class="ewd-us-dashboard-support-widgets">
							...
							<li>
								<a href="https://www.etoilewebdesign.com/support-center/?Plugin=US&Type=FAQs" target="_blank">
				...
				*/ ?>
				...
				<?php /*<div class="ewd-us-dashboard-new-widget-box <?php echo ( ($hideReview != 'Yes' and $Ask_Review_Date < time()) ? 'ewd-widget-box-two-thirds' : 'ewd-widget-box-full' ); ?>">
			...
			<div id="ewd-us-dashboard-new-footer-one">
				<div class="ewd-us-dashboard-new-footer-one-inside">
					...
					<div class="ewd-us-dashboard-new-footer-one-buttons">
						<a class="ewd-us-dashboard-new-upgrade-button" href="https://www.fivestarplugins.com/license-payment/?Selected=US&Quantity=1" target="_blank">UPGRADE NOW</a>
					</div>
				</div>
		...
		<div id="ewd-upcp-dashboard-new-footer-two">
			<div class="ewd-upcp-dashboard-new-footer-two-inside">
				...
				<ul class="ewd-upcp-dashboard-new-footer-two-menu">
					...
					<li><a href="https://www.etoilewebdesign.com/support-center/?Plugin=US&Type=FAQs" target="_blank">Documentation</a></li>
