...
<li <?php echo ewd_format_classes( $this->classes ); ?> id="ewd-us-slide-<?php echo $this->slide_count; ?>" <?php echo $this->print_lightbox_data(); ?> >
				
	<div class='ewd-us-video-holder iframetrack'>
		<div>
	...
	<div class="ewd-us-slide-text">
		...
		<div class="ewd-us-slide-title"><?php echo $this->title; ?></div>
		<div class="clear"></div>
		
		<div class="ewd-us-slide-excerpt"><?php echo $this->filtered_content; ?></div>
		<div class="clear"></div>
	...
	<?php if ( $ewd_us_controller->settings->get_setting( 'carousel' ) and $ewd_us_controller->settings->get_setting( 'carousel-link-to-full' ) ) { ?> 
		...
		<a href="' . get_the_permalink( $this->ID ) . '" class="ewd-us-carousel-link-to-full"></a>
	<?php } ?>

	<?php if ( $ewd_us_controller->settings->get_setting( 'mobile-link-to-full' ) ) { ?> 
		
		<a href="' . get_the_permalink( $this->ID ) . '" class="ewd-us-mobile-link-to-full"></a>
	<?php } ?>
</li>