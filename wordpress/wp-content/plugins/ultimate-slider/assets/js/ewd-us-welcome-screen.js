jQuery(document).ready(function() {
	...
	jQuery( '.ewd-us-welcome-screen-add-slide-button' ).on( 'click', function() {
		...
		var data = 'slide_title=' + slide_title + '&slide_image=' + slide_image + '&slide_description=' + slide_description + '&action=us_welcome_add_slide';
	...
	jQuery( '.ewd-us-welcome-screen-add-slider-page-button').on( 'click', function() {
		...
		var data = 'slider_page_title=' + slider_page_title + '&action=us_welcome_add_slider_page';
		jQuery.post( ajaxurl, data, function(response) {} );
	...
	jQuery( '.ewd-us-welcome-screen-save-options-button' ).on( 'click', function() {
		...
		var data = 'autoplay_slideshow=' + autoplay_slideshow + '&timer_bar=' + timer_bar + '&carousel=' + carousel + '&aspect_ratio=' + aspect_ratio + '&slide_indicators=' + slide_indicators + '&action=us_welcome_set_options';
		jQuery.post( ajaxurl, data, function( response ) {} );
	});
