...
class ewdusViewSlider extends ewdusView {
	...
	public function get_slides() { 
		...
		if ( $this->slider_type == 'woocommerce' ) { 
			...
			while ( $slider_query->have_posts() ) : $slider_query->the_post();
				...
				$this->slides[] = new ewdusViewSlideWooCommerce( $post );
		...
		elseif ( $this->slider_type == 'upcp' ) { 
			...
			while ( $slider_query->have_posts() ) : $slider_query->the_post();
				...
				$this->slides[] = new ewdusViewSlideUPCP( $post );
		...
		elseif ( $this->slider_type == 'urp' ) {
			...
			while ( $slider_query->have_posts() ) : $slider_query->the_post();
				...
				$this->slides[] = new ewdusViewSlideURP( $post );
		...
		elseif ( $this->post__in_string != '' ) {
			...
			while ( $slider_query->have_posts() ) : $slider_query->the_post();
				...
				$this->slides[] = new ewdusViewSlide( $post );
	...
	public function enqueue_assets() {
	    ...
	    wp_localize_script( 'ewd-us-js', 'ewd_us_php_data', $slider_data );
